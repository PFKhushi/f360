...
export default function Register(){
  return (
    <div className='h-screen flex justify-center items-center bg-gradient-to-b from-primary-1 to-primary-5'>
      <div className='flex flex-col items-center gap-[30px] bg-primary-4 w-[669px] h-[652px] drop-shadow-[10px_10px_4px] drop-shadow-black/25 rounded-[20px] text-white'>
        <picture className='pt-[36px]'>
          <img
        ...
        <p className='font-louis-george-cafe text-[24px]'>Seja bem-vindo à Fábrica de Software</p>
        <div className='w-[503px] h-[1px] bg-white' />
        <p className='font-roboto text-[24px]'>Qual a classificação do seu perfil?</p>
        <div className='font-roboto text-[24px] flex pt-[30px] gap-[50px]'>
