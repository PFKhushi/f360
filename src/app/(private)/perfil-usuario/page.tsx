        ...
        <article className='flex p-4 pl-8 md:pl-20'>
          <section className='flex flex-col justify-around w-[45%]'>
            <div>
              ...
              <p className='font-light break-words'>participante@gmail.com</p>
            </div>
            <div>
              <h1 className='font-medium text-[18px]'>Matrícula</h1>
              <p className='font-light'>123456789</p>
            </div>
            <div>
          ...
          <section className='flex flex-col justify-around w-[45%]'>
            <div>
              ...
              <p className='font-light'>098.765.432-32</p>
            </div>
            <div>
              <h1 className='font-medium text-[18px]'>Telefone</h1>
              <p className='font-light'>(99)91111-1111</p>
            </div>
            <div>
              <h1 className='font-medium text-[18px]'>Status</h1>
              <p className='font-light'>Extensionista</p>
            </div>
          </section>
        </article>
