...
def list_imersoes_swagger():
    return swagger_auto_schema(
        operation_description="Lista todas as imersões cadastradas. "
                             "Participantes só veem imersões ativas.",
        responses={
            200: openapi.Response('Lista de imersões', ImersaoSerializer(many=True)),
...
def create_imersoes_swagger():
    return swagger_auto_schema(
        operation_description="Cria uma nova imersão. Requer permissão de administrador.",
        request_body=ImersaoSerializer,
        responses={
            201: success_imersao_schema,
